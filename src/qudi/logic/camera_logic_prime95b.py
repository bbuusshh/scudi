...
# from logic.generic_logic import GenericLogic # DUNNO
...
class CameraLogic(LogicBase):#GenericLogic):
    """
    Control a camera.
    """
    ...
    def start_single_acquistion(self):
        """Does a single image acquisitiong and updates the _last_image variable as well as the display.
        """
    ...
    def start_loop(self):
        ...
        short delay or none at all will cause the GUI to freeze.
        """
        self.enabled = True
