...
class PulserClient(Base):
    ...
    def set_sequence(self, sequence = [(["ch1", "ch2"], 100)]):
        return self.send_request("set_sequence", action=sequence)   
    def run(self):
        return self.send_request("run")   
    def halt(self):
        return self.send_request("halt")  