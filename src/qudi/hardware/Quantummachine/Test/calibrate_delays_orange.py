...
with program() as calib_delays:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        wait(1000, 'AOM_green', 'AOM_orange','SPCM')
    ...
    with stream_processing():
        times_st.histogram([[i, i + (resolution - 1)] for i in range(0, meas_len_orange, resolution)]).save("times_hist")
        n_st.save("iteration")
