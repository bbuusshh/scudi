...
with program() as calib_delays:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        wait(initial_delay_cycles, "AOM_green")  # wait before starting PL
        play("laser_ON", "AOM_green", duration=laser_len_cycles)

        wait(initial_delay_cycles + (laser_len_cycles - mw_len_cycles//2) // 2, "NV1")  # delay the microwave pulse
        play("cw", "NV1", duration=mw_len_cycles)  # play microwave pulse
